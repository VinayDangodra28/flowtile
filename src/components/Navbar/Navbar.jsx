...
const Navbar = () => {
  ...
  return (
    <nav
      className={`flex items-center justify-between px-8 transition-colors duration-300
    ...
    >
      <div className="flex items-center">
        ...
        <h1 className={`text-2xl font-semibold ml-2 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>FlowTile</h1>
        
        {/* Project Name Display - Only show when in editor */}
